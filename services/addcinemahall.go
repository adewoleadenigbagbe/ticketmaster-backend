...
func (cinemaService CinemaService) AddCinemaHall(request CinemaHallRequest) (CinemaHallResponse, models.ErrrorResponse) {
	var err error
	var errs []error
	...
	if len(errs) > 0 {
		return CinemaHallResponse{}, models.ErrrorResponse{StatusCode: http.StatusOK, Errors: errs}
	}
	...
	return resp, models.ErrrorResponse{}
}
